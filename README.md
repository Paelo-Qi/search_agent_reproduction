...
The commands below document the earlier Agent behavior. Phase 6B.1 sets
`AGENT_BEHAVIOR_VERSION=4`; use a new run ID for future formal runs after
validating `base-dev30-v4` (see
